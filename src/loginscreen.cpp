    ...
    : Window("GUI bank")
{
    ...
    this->side_box1.set_size_request(240, 720);
    this->side_box2.set_size_request(5, 720);
    this->side_box3.set_size_request(5, 720);
    this->side_box4.set_size_request(330, 720);
